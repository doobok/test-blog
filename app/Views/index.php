        ...
        <div class="flex justify-center">
            <div class="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Database is
                                missing</h3>
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">Database is missing, test data needs to be generated.
                                    Please push the button to generate them.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <a href="/seed"
                       class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">Generate</a>
                </div>
            </div>
        </div>
    <?php endif; ?>
    <div class="py-12 bg-white my-4">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Make your
                    choice</p>
                <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">Start searching for news from the relevant
                    section</p>
            </div>
            ...
            <div class="mt-10">
                <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    <div class="relative">
                        ...
                        <dd class="mt-2 ml-16 text-base text-gray-500">Categories rubricator. List of news categories
                        </dd>
